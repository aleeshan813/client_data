    ...
    <div class="pagetitle">
      ...
      <div class="p-2">
        ...
        <div class="p-1" role="group" aria-label="Basic example">
          <a href="select_All_client_data.php"><button class="btn btn-success w-30 p-2" type="submit">Select All</button></a>
        </div>
                        ...
                        <tr>
                          ...
                          <td >
                            <div class=" form-check p">
                                <input class="form-check-input bg-danger" name="view_data[]" type="checkbox" value="<?php echo $row[0] ?>" id="flexCheckDefault">
                            </div>
                          </td>
                        </tr>
